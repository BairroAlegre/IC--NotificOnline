...
<html>
    <head>
        ...
        <title>Mensagens Recebidas - NotificOnline</title>
    </head>
    <body>
        <nav class="navbar navbar-default">
            <div class="container-fluid" style="background-color:white">
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="active" ><a href="msgrecebidas.php">Recebidas</a></li>
        ...
        <div class="well">
            <div class="container-fluid">
                <ul class="list-group pull-left" style="width:70%; height:90%;">
                    <li class="list-group-item"><h1 class="text-center">Mensagens Recebidas</h1></li>
                ...
                <ul class="list-group pull-right" style="width:30%; height:50%;">
