...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Mensagens Enviadas - NotificOnline</title>
        ...
        <nav class="navbar navbar-default">
            <div class="container-fluid" style="background-color:white">
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="active" ><a href="msgenviadas.php">Enviadas</a></li>
        ...
        <div class="well">
            <div class="container-fluid">
                <ul class="list-group pull-left" style="width:70%; height:90%;">
                    <li class="list-group-item"><h1 class="text-center">Mensagens Enviadas</h1></li>
